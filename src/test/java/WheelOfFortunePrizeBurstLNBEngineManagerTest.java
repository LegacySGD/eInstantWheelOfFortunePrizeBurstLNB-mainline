...
public class WheelOfFortunePrizeBurstLNBEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(WheelOfFortunePrizeBurstLNBEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/WheelOfFortunePrizeBurstLNBIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/WheelOfFortunePrizeBurstLNBIW/InitOutcome.xml").getDocumentElement();
